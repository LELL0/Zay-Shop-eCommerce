...
if(isset($_GET["status"])){
 if($_GET["status"] == 2){
    ...
    echo "<p style='text-align:center;color:green;font-weight:bold;font-size:20px;'>uploading done successfully</p>";
}
...
<section class="commercial-asd container">
    ...
    <input class="kolo" type="text" name="ProTitle" placeholder="Title" alt="wating"title="Pleaes write Your Title" required >
    <textarea placeholder="Detalis" name="ProDetalis" id="my-input" class="form-control " rows="5" required></textarea>
    <input class="kolo" type="text" name="Proprice" placeholder="price" alt="wating"title="Pleaes write Your price" required>
    <input class="kolo" type="file" name="image" required>
        <select class="kolo" name="Maincategory" required>
        
        <option value='' hidden="on" required>CategoryName</option>
        <?php                                        
    ...
    <input name="add" class="btn" type="submit" value="save" >
    </form>
