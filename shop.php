 ...
 ?>
    ...
    <div class="container py-5">
        <div class="row">
            ...
            $shopingCart = mysqli_query($conShop,"SELECT COUNT(ShoppingCartId) as TotalQuantity FROM shoppingcart WHERE clientId=$_SESSION[loggedInUserId]");
            $rowShopingCart =mysqli_fetch_array($shopingCart);
            
            echo "<h1><a href='ShoppingCart.php'>My Cart: $rowShopingCart[TotalQuantity] Products</a></h1>
        ...
        ?>
                ...
                <ul class="list-unstyled templatemo-accordion">
                    <li class="pb-3">
                        ...
                        <ul class="collapse show list-unstyled pl-3">
                            <li><a class="text-decoration-none" href="shop.php?Gender=M">Men</a></li>
                            <li><a class="text-decoration-none" href="shop.php?Gender=F">Women</a></li>
                        </ul>
                    </li>
                    <li class="pb-3">
                        <a class="collapsed d-flex justify-content-between h3 text-decoration-none" href="#">
                        ...
                        <ul id="collapseTwo" class="collapse list-unstyled pl-3">
                            <li><a class="text-decoration-none" href="shop.php?Brand=NIKE">NIKE</a></li>
                            <li><a class="text-decoration-none" href="shop.php?Brand=ADIDAS">ADIDAS</a></li>
                        </ul>
                    </li>
                    <li class="pb-3">
                        <a class="collapsed d-flex justify-content-between h3 text-decoration-none" href="#">
                        ...
                        <ul id="collapseThree" class="collapse list-unstyled pl-3">
                            <li><a class="text-decoration-none" href="shop.php?Specification=Bag">Bag</a></li>
                            <li><a class="text-decoration-none" href="shop.php?Specification=Sweather">Sweather</a></li>
                            <li><a class="text-decoration-none" href="shop.php?Specification=Sunglass">Sunglass</a></li>
                        </ul>
                    </li>
                </ul>
                <a class="collapsed d-flex justify-content-between h2 text-decoration-none" href="shop.php">
                            Reset filter
            ...
            if(isset($_GET['Specification'])){
                $Products = mysqli_query($conShop,"SELECT * FROM products WHERE Specification='$_GET[Specification]'");
            }elseif(isset($_GET['Brand'])){
                $Products = mysqli_query($conShop,"SELECT * FROM products WHERE Brand='$_GET[Brand]'");
            }elseif(isset($_GET['Gender'])){
                $Products = mysqli_query($conShop,"SELECT * FROM products WHERE Gender='$_GET[Gender]'");
            }else{
            ...
            while ($rowProducts = mysqli_fetch_array($Products)){
                if ($rowProducts["IsAvailable"]=="AVAILABLE"){
                   ...
                   echo "
                    ...
                    <div class='card mb-4 product-wap rounded-0'>
                        ...
                        <div class='card-body'>
                            <a href='shop-single.php' class='h3 text-decoration-none'>$rowProducts[Title]</a>
